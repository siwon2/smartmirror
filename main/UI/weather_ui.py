...
class Ui_Form(object):
    # weather_icon, label_temperature, label_weather
    widget_List = [
    ]
    def setupUi(self, Form):
        ...
        self.weather_icon.setGeometry(QtCore.QRect(136, 15, 128, 128))
        self.weather_icon.setText("")
        self.weather_icon.setObjectName("weather_icon")
        self.weather_icon.setStyleSheet("color: rgb(255, 255, 255);")
        self.widget_List.append(self.weather_icon)
        ...
        self.widget_List.append(self.label_temperature)
        ...
        self.widget_List.append(self.label_weather)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_weather.setText(_translate("Form", "test"))
